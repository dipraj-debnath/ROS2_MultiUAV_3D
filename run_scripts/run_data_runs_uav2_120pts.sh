...
# Usage: ./run_data_runs_uav2_120pts.sh <start_run> <end_run>
# Example: ./run_data_runs_uav2_120pts.sh 1 10
...
for N in $(seq "$START_RUN" "$END_RUN"); do
    ...
    python3 deckga_ros2/drone_pairwise_distance_logger.py \
        ...
        --run_tag "ex${N}_120pts_uav2_pairwise_distance_run_${N}" &
    LOGGER_PID=$!
    ...
    python3 deckga_ros2/deckga_execute_antarctica.py \
        --deckga_pkl "deckga_ros2/data/deckga_output_antarctica_120_uav2_ex${N}.pkl" \
        ...
        --wp_settle_s 0.3 \
        --log_dir results_antarctica_csv \
        --run_tag "ex${N}_120pts_uav2_deckga_run_${N}"
    EXEC_EXIT=$?
    set -e
