...
TOTAL=10
RESULTS="results_csv/classical_kmeans_dega_5uavs_60_points_10_runs_results.txt"
...
{
    echo "Classical KMeans DEGA | 5 UAVs | 60 Waypoints | 10 Runs Results"
    echo "antarctica_aspa135_m3 | start_points: 8.00,4.50,32.60 ; 8.00,8.00,32.70 ; 4.50,8.00,32.80 ; 4.50,2.50,32.90 ; 6.00,5.00,32.99"
    echo "==========================================================================="
    echo ""
} > "$RESULTS"

for i in $(seq 1 $TOTAL); do
    echo "=== Running Classical KMeans DEGA 60pts 5-UAV Run $i/$TOTAL ==="

    OUT=$(python3 "DEGA_Classical_Kmeans/DEGA_Classical_Kmeans.py" \
        --points_pkl "$POINTS_PKL" \
        --num_uavs 5 \
        --start_points="$START_POINTS" \
        --out_pkl "$OUT_DIR/classical_kmeans_dega_output_antarctica_60_uav5_ex${i}.pkl" \
...
for i in range(1, 11):
    pkl_path = out_dir / f"classical_kmeans_dega_output_antarctica_60_uav5_ex{i}.pkl"
