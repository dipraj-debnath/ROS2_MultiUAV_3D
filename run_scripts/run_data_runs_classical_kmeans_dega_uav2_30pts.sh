...
# Usage: ./run_data_runs_classical_kmeans_dega_uav2_30pts.sh <start_run> <end_run>
# Example: ./run_data_runs_classical_kmeans_dega_uav2_30pts.sh 1 10
...
YAML
    ...
    python3 deckga_ros2/deckga_execute_antarctica.py \
        ...
        --wp_settle_s 0.3 \
        --log_dir results_antarctica_csv \
        --run_tag "ex${N}_30pts_uav2_classical_kmeans_dega_run_${N}"
    EXEC_EXIT=$?
    set -e
