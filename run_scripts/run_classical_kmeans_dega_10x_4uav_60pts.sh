...
TOTAL=10
RESULTS="results_csv/classical_kmeans_dega_4uavs_60_points_10_runs_results.txt"
...
{
    echo "Classical KMeans DEGA | 4 UAVs | 60 Waypoints | 10 Runs Results"
    echo "antarctica_aspa135_m3 | start_points: 7.00,4.00,32.00 ; 7.00,8.00,32.09 ; 4.00,8.00,32.31 ; 4.00,4.00,32.20"
    echo "==========================================================================="
    echo ""
} > "$RESULTS"

for i in $(seq 1 $TOTAL); do
    echo "=== Running Classical KMeans DEGA 60pts 4-UAV Run $i/$TOTAL ==="

    OUT=$(python3 "DEGA_Classical_Kmeans/DEGA_Classical_Kmeans.py" \
        --points_pkl "$POINTS_PKL" \
        --num_uavs 4 \
        --start_points="$START_POINTS" \
        --out_pkl "$OUT_DIR/classical_kmeans_dega_output_antarctica_60_uav4_ex${i}.pkl" \
...
for i in range(1, 11):
    pkl_path = out_dir / f"classical_kmeans_dega_output_antarctica_60_uav4_ex{i}.pkl"
