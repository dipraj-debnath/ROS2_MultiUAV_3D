...
# Usage: ./run_data_runs_classical_kmeans_dega_uav5_30pts.sh <start_run> <end_run>
...
YAML
    ...
    python3 deckga_ros2/drone_pairwise_distance_logger.py \
        ...
        --run_tag "ex${N}_30pts_uav5_classical_kmeans_dega_pairwise_run_${N}" &
    LOGGER_PID=$!
    ...
    python3 deckga_ros2/deckga_execute_antarctica.py \
        --deckga_pkl "deckga_ros2/data/classical_kmeans_dega_output_antarctica_30_uav5_ex${N}.pkl" \
        ...
        --wp_settle_s 0.3 \
        --log_dir results_antarctica_csv \
        --run_tag "ex${N}_30pts_uav5_classical_kmeans_dega_run_${N}"
    EXEC_EXIT=$?
    set -e
