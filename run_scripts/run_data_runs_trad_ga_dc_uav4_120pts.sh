...
# Usage: ./run_data_runs_trad_ga_dc_uav4_120pts.sh <start_run> <end_run>
# Example: ./run_data_runs_trad_ga_dc_uav4_120pts.sh 1 10
...
YAML
    ...
    python3 deckga_ros2/drone_pairwise_distance_logger.py \
        ...
        --run_tag "ex${N}_120pts_uav4_trad_ga_dc_pairwise_run_${N}" &
    LOGGER_PID=$!
    ...
    python3 deckga_ros2/deckga_execute_antarctica.py \
        --deckga_pkl "deckga_ros2/data/traditional_ga_divide_conquer_output_antarctica_120_uav4_ex${N}.pkl" \
        ...
        --wp_settle_s 0.3 \
        --log_dir results_antarctica_csv \
        --run_tag "ex${N}_120pts_uav4_trad_ga_dc_run_${N}"
    EXEC_EXIT=$?
    set -e
